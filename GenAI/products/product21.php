...
<div class="product-grid">
    ...
    <h2>Neon Dragon Hoodie</h2>
    <h4>Rating: <?php echo $averageRating; ?></h4>
    <p>A hoodie that glows in the dark to make you the center of attention.</p>
    <button class="button">Buy Now</button>
    <br><br><br>
    <button class = "button" onclick="showReviews()">Show Reviews</button>
    <div class="review-section">
    <h3>Add Your Review</h3>
    <form action="../submit_review_gen.php" method="post">
...
function showReviews() {
    ...
    window.location.href = '../reviews_gen.php?product_id=' + <?php echo $productID; ?>;
}
</script>
</html>
